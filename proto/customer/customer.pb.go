...
func (x *CustomerRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type CustomerServiceClient interface {
	New(ctx context.Context, in *CustomerReq, opts ...grpc.CallOption) (*CustomerRes, error)
}
...
func (c *customerServiceClient) New(ctx context.Context, in *CustomerReq, opts ...grpc.CallOption) (*CustomerRes, error) {
	out := new(CustomerRes)
	err := c.cc.Invoke(ctx, "/CustomerService/New", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CustomerServiceServer interface {
	New(context.Context, *CustomerReq) (*CustomerRes, error)
}
...
func (*UnimplementedCustomerServiceServer) New(context.Context, *CustomerReq) (*CustomerRes, error) {
...
func _CustomerService_New_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CustomerReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CustomerServiceServer).New(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/CustomerService/New",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).New(ctx, req.(*CustomerReq))
	}
...
var _CustomerService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "New",
			Handler:    _CustomerService_New_Handler,
		},
	},
